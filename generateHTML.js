...
function generateHTML(data, data2, color) {
  return `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8" />
            ...
            <div class="row">
              ...
              <div class="row">
               ...
               <div class="card">
                  ...
                  <h4><i class="fas fa-star"></i> ${data2.items[0].stargazers_count} <a href="${data2.items[0].html_url}" _target="blank">${data2.items[0].name}</a></h4>
                  <h4><i class="fas fa-star"></i> ${data2.items[1].stargazers_count} <a href="${data2.items[1].html_url}" _target="blank">${data2.items[1].name}</a></h4>
                  <h4><i class="fas fa-star"></i> ${data2.items[2].stargazers_count} <a href="${data2.items[2].html_url}" _target="blank">${data2.items[2].name}</a></h4>
                  </div>
               </div>
                <div class="col">
                <div class="card">
